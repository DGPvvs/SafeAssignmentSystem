...
namespace SafeAssignmentSystem.DataBase.Migrations
{
    ...
    [Migration("20230624095841_SeedUsers")]
            ...
            modelBuilder.Entity("SafeAssignmentSystem.DataBase.Data.DatabaseModels.Account.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ae7f0aff-0fb0-4a08-b024-5f158cfb20a3",
                            EmailConfirmed = false,
                            FirstName = "Дан",
                            LastName = "Игнатов",
                            LockoutEnabled = false,
                            NormalizedUserName = "IGNATOV.DAN",
                            PasswordHash = "AQAAAAEAACcQAAAAEKolujeKP20XM/wBB2X6+frY5jWGMJ535VFTfS/YYGXwmNu0wpBwL5DA51YFk6VcbQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "88728c8c-3c97-4f3d-8484-3690c7f16817",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "188ef6a6-e52c-4494-a4ea-f175aa643385",
                            EmailConfirmed = false,
                            FirstName = "Сергей",
                            LastName = "Попов",
                            LockoutEnabled = false,
                            NormalizedUserName = "POPOV.SERGEY",
                            PasswordHash = "AQAAAAEAACcQAAAAED7EI5cQp56QxqWZq5EVUUXYWA1sCTDUbUT4BtR/nzs2+ldQj89l3+T0Dn8gmNZoUQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1aaa77f8-6021-4575-b3b5-e6e2ec4dca82",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8ba20df1-fbca-44d7-b808-6be56a6b4f7b",
                            EmailConfirmed = false,
                            FirstName = "Жерар",
                            LastName = "Славчев",
                            LockoutEnabled = false,
                            NormalizedUserName = "GERAR.SLAVTCHEV",
                            PasswordHash = "AQAAAAEAACcQAAAAENp9YL+nAKrsDNp/AI+Gsc0FSdrY/EBFEzaALRQ65LHOsSOQM1M4J3WxNDeniKt5jw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "07b6b578-6efc-45d7-9f4a-55cf842bc209",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d56e74d2-fcb9-4ec0-b1ee-f76059d3e4f1",
                            EmailConfirmed = false,
                            FirstName = "Руси",
                            LastName = "Магичов",
                            LockoutEnabled = false,
                            NormalizedUserName = "RUSI.MAGITCHOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEBw51AE1V918CNxrSyBeNfeYL8nYjoe1Gs9cEinfUw2O/ngtG8Lxa/BG/nL1bYK1Qg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "96441461-a19c-419d-9c2f-e99dab151cf6",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "30ee0efa-7e6a-4909-a23f-1738d14686a4",
                            EmailConfirmed = false,
                            FirstName = "Биню",
                            LastName = "Тошков",
                            LockoutEnabled = false,
                            NormalizedUserName = "BINUY.TOCHKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAECD46nOfGfc+XGBQ0F05KIShuK+ZxfXy1mM8xTT/zY/Lhmfyh7l1tBZekB7LXEcWGQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "51bab9d3-70ad-4882-b3b8-288f9bbb16dd",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1c49e2b3-d51e-4352-9e1a-90367181ad9b",
                            EmailConfirmed = false,
                            FirstName = "Пейо",
                            LastName = "Ленков",
                            LockoutEnabled = false,
                            NormalizedUserName = "PEYO.LENKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEAAjavQ9okXYr+Cs+MQeIWnWDTVh5OEyd5U/eWkwBWGzDfbMoY+gFevLrTS70kCIhQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d5a58bb7-9b23-401b-b59d-d310c8c8ea02",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ba554540-7595-4b8c-82af-178593a560e2",
                            EmailConfirmed = false,
                            FirstName = "Аню",
                            LastName = "Панчев",
                            LockoutEnabled = false,
                            NormalizedUserName = "ANUY.PANTCHEV",
                            PasswordHash = "AQAAAAEAACcQAAAAEJVdvkQU9ALSGXcHux8XD+kifz0vPshU30WSagZ0FJITUbNqPwCln//9jKUcKayhhg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "eac83d0f-1e04-4cd9-beba-93ffdd400491",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d4f59425-4686-4c06-bdf6-6c17cf3459e5",
                            EmailConfirmed = false,
                            FirstName = "Флоро",
                            LastName = "Станов",
                            LockoutEnabled = false,
                            NormalizedUserName = "FLORO.STANOV",
                            PasswordHash = "AQAAAAEAACcQAAAAENceFofDAAe8NZF/TL34PMX/3Tp/CL0EZyWbKD3WA3r/5nOwq2VMfpjvuxEgrFVFnw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7a8d3f05-7a69-49d0-bc48-6855292cd16c",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8b09d10c-71ae-49ec-b399-4e4f71a1c919",
                            EmailConfirmed = false,
                            FirstName = "Доко",
                            LastName = "Цанимиров",
                            LockoutEnabled = false,
                            NormalizedUserName = "DOKO.TSANIMIROV",
                            PasswordHash = "AQAAAAEAACcQAAAAEAbWdiIwHgeSgF4H7aERDUNkbHQodU+n/BvsMOi/VgOphNnKGwxl5Z0Tq/WQYPSIXQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fa5693e3-f77e-4c83-bd94-74397ba1b4c4",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "00467844-efc0-4e5c-8c06-ce0f72449416",
                            EmailConfirmed = false,
                            FirstName = "Силвиян",
                            LastName = "Янов",
                            LockoutEnabled = false,
                            NormalizedUserName = "SILVIYAN.YANKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEBhMTIQx2JL7VMS74MsYqgyyc2yIfLOlPewDU/bcUfM7wDXBDeDomV6dvg7/OZu4rA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "68ef19f7-cfc8-46ba-9d2c-7350e8834810",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "05977fb4-e6b6-4f36-9d8f-b033328f4daf",
                            EmailConfirmed = false,
                            FirstName = "Менко",
                            LastName = "Мирков",
                            LockoutEnabled = false,
                            NormalizedUserName = "MENKO.MIRKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEA33MW6VLw7DjjuJZgOAcIQfQj4CM6KvRi8+NEftI83Su/H0DhYdR6cz7enCDIxgaA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c6916b2b-98bb-46a0-a07e-d2e2c16fe842",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4daddd9d-9f19-46c2-964d-f0c134c63272",
                            EmailConfirmed = false,
                            FirstName = "Лазо",
                            LastName = "Шишманов",
                            LockoutEnabled = false,
                            NormalizedUserName = "LAZO.CHICHMANOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEN/dB7/pM/LsCKw0eUFjJGIh4VikbnUYhlAfJZquamLQxtULGpn++80kSVtINdk8cw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ebd8340c-b8df-414b-9af1-a7a9dc17e234",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c422cffd-793a-4270-bc50-aebb7af39ab9",
                            EmailConfirmed = false,
                            FirstName = "Столипен",
                            LastName = "Тонев",
                            LockoutEnabled = false,
                            NormalizedUserName = "STOLIPEN.TONEV",
                            PasswordHash = "AQAAAAEAACcQAAAAEPHYwQjRigzh7RDgCtZXQdw3t5ZAgsxHsgsPXRNdMxfH4eU7wRYmNuTLnlK/adohNg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4472ced2-dfd8-4365-b044-fc2142e44090",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "47324b8a-8cd6-43f6-9f88-ba0ffd317f7c",
                            EmailConfirmed = false,
                            FirstName = "Дарен",
                            LastName = "Павков",
                            LockoutEnabled = false,
                            NormalizedUserName = "DAREN.PAVKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEHCYfhgm2hyjkx+28UVzBGlBxBebxZHEmB/ZbnkZT9/o7K2YDcqolJUynGCcpC7mKw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8ca3e768-722e-45bd-a1ad-10377a213ad4",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a5eb196f-0d0b-4069-9585-b4cf8c793719",
                            EmailConfirmed = false,
                            FirstName = "Драгни",
                            LastName = "Тодоров",
                            LockoutEnabled = false,
                            NormalizedUserName = "DRAGNI.TODOROV",
                            PasswordHash = "AQAAAAEAACcQAAAAEByxh+Ez66EnmLOuYYR3AIJz9BMkYOteWLhvwkRUciS9JO4ZTn4TWx+MO/DIi7uzzQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "622387dd-c119-4533-9d02-a23dc4e10c43",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8f415a7b-d291-462f-b3b4-afd964c281ad",
                            EmailConfirmed = false,
                            FirstName = "Данимил",
                            LastName = "Тинков",
                            LockoutEnabled = false,
                            NormalizedUserName = "DANIMIL.TINKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEFZxHv7ZcfSXNrLyQFYddWePlpmmDMbudZrhKLfq7Xvkk8WawjEgMQkhPJIqQM/nKg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7e5f4f8d-9726-41e1-b0c9-a9004c7559f3",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "40736c5a-4f53-487e-b027-5be4179da82c",
                            EmailConfirmed = false,
                            FirstName = "Дориян",
                            LastName = "Славейков",
                            LockoutEnabled = false,
                            NormalizedUserName = "DORIYAN.SLAVEYKOV",
                            PasswordHash = "AQAAAAEAACcQAAAAEGmJrHQ+u7O9moTVhxAwYzQjmNho8ULbQP5dltyfq8RCkLl6egGhp4HDZltBuBLG9w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b59d31e9-53e5-49a3-92c3-164d0c2ab728",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7533d07d-e2f1-4813-80ff-d6bd845c1a74",
                            EmailConfirmed = false,
                            FirstName = "Друмчо",
                            LastName = "Светозаров",
                            LockoutEnabled = false,
                            NormalizedUserName = "DRUMTCHO.SVETOZAROV",
                            PasswordHash = "AQAAAAEAACcQAAAAELlSe8btFiyCTT5mDMmcf1rLMZsc6BcXOISjA0Ya4E6VqYqmb7qq8J4747Hfjhkk3w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2a855da8-be0f-4d49-b679-66c505be5d5a",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8d79fc52-b24f-40a1-8b84-4cb2d3aee1f6",
                            EmailConfirmed = false,
                            FirstName = "Захари",
                            LastName = "Тодеев",
                            LockoutEnabled = false,
                            NormalizedUserName = "ZAHARI.TODEEV",
                            PasswordHash = "AQAAAAEAACcQAAAAEAbjYbZOjHOg6uHR7VGqUE6QZ81jaQtKZJAXbbMMOEnjjOqTw95XQ4+MoSPoRxfIXw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4bbb874c-81dc-448e-bfc3-7ad3335872ea",
                            TwoFactorEnabled = false,
